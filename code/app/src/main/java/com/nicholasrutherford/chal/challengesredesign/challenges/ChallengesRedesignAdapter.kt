...
class ChallengesRedesignAdapter (private val viewModel: ChallengesRedesignViewModel, private val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
